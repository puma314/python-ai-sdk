...
"""Data content type for language model v2.

Translated from: packages/provider/src/language-model/v2/language-model-v2-data-content.ts
"""
...
LanguageModelV2DataContent = bytes | str
